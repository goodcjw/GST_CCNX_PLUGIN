...
#define GST_CCNX_DATA_WINDOW_SIZE     18
#define GST_CCNX_CMD_WINDOW_SIZE      2
#define GST_CCNX_INTEREST_LIFETIME    4096
#define GST_CCNX_INTEREST_RETRIES     1
#define GST_CCNX_CHUNK_SIZE           3900
#define GST_CCNX_FRESHNESS            1800      /* 30 * 60 seconds */
#define GST_CCNX_DEPKT_QUEUE_TIMEOUT  1         /* in second */
#define GST_CCNX_CCN_GET_TIMEOUT      1000      /* 1000 ms */
